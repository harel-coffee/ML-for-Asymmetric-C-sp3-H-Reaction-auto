...
mydata = np.genfromtxt('beta_ch_ee_mls_APAO.csv', delimiter=',')
...
mydata_withsynthetic = np.genfromtxt('beta_ch_ee_mls_APAO_syn_upto80_borderline2.csv', delimiter=',')
...
def compute_testrmse(seed,best_length_val):
    ...
    with open('beta_ch_ee_mls_APAO_syn_upto80_borderline2_synthetic-gpr-rbf-length-out.csv', 'a') as csvFile:
