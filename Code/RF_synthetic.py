...
mydata = np.genfromtxt('beta_ch_ee_mls_MPAA_MPAHA_MPAAM_APAO_random_number.csv', delimiter=',')
...
mydata_withsynthetic = np.genfromtxt('beta_ch_ee_mls_MPAA_MPAHA_MPAAM_APAO_random_number_syn_upto80_borderline2.csv', delimiter=',')
...
def compute_testrmse(seed,best_numest):
    ...
    with open('beta_ch_ee_mls_MPAA_MPAHA_MPAAM_APAO_random_number_syn_upto80_borderline2_rf-synthetic-n-estimator-out.csv', 'a') as csvFile:
